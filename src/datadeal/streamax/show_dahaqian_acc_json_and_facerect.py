...
facerect_dir = r'H:\pro\fatigue\data\dahaqian\fatigue_dahaqian_json'
...
for vprefix in infos:
    ...
    json_name = vprefix.split('/')[1] + '.json'
    json_path = os.path.join(facerect_dir, json_name)
    ...
    while True:
        ...
        sx,sy,ex,ey = json_infos[imgname]['bbox']
